...
const HeaderMain = () => {
  ...
  return (
    <>
      <header>
        <div
          className={`header__area header-transparent is-border-bottom p-relative is-header-large
                 ${isSticky ? "bd-sticky" : ""}`}
        >
              ...
              <div className="header__main">
                ...
                <div className="header__right">
                  <div className="header__action d-flex align-items-center">
                    <div className="header__btn-wrap d-none d-sm-inline-flex d-inline-flex align-items-center gap-5">
                      <Link
                        className="bd-btn is-btn-anim bordered-blue"
                        href="/contact"
                      >
      ...
      <OffcanvasArea
        isOpenInfoSidebar={isOpenInfoSidebar}
        setIsOpenInfoSidebar={setIsOpenInfoSidebar}
      />
      <div
        onClick={() => setIsOpenInfoSidebar(false)}
        className={
          isOpenInfoSidebar
      ...
      <div
        onClick={() => setIsOpenInfoSidebarTwo(false)}
        className={
          isOpenInfoSidebarTwo
            ? "offcanvas__overlay overlay-open"
            : "offcanvas__overlay"
        }
      ></div>
