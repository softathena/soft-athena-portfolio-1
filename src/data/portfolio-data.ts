...
const portfolio_data:TPortfolio[] = [
    {
      ...
      description: "Developed a robust e-learning mobile app using Flutter, offering seamless video streaming and interactive quizzes for students.",
      technologies: ["Flutter", "Dart", "Firebase"],
      duration: "3 months",
      clientFeedback: "The app has received amazing feedback for its speed and user-friendly interface.",
    ...
    },
    {
      ...
      description: "Built a scalable and secure chat application using the MERN stack, featuring group chats and end-to-end encryption.",
    ...
    },
    {
      ...
      description: "Designed and implemented a responsive portfolio website tailored for creative professionals to showcase their work.",
    ...
    },
    {
      ...
      description: "Developed a reusable and highly customizable React template for e-commerce platforms, including cart and payment integrations.",
    ...
    },
    {
      ...
      description: "Created a robust ERP system using .NET, streamlining business operations and improving data accuracy for the client.",
    ...
    },
    {
      ...
      description: "Designed a modern, intuitive dashboard for an analytics platform, enhancing usability and data visualization.",
    ...
    },
    {
      ...
      description: "Developed a cross-platform health monitoring app with real-time data visualization and integration with wearable devices.",
    ...
    },
    {
      ...
      description: "Built a feature-rich social media platform for content creators, including live streaming and monetization options.",
      technologies: ["MongoDB", "Express", "React", "Node.js"],
      duration: "5 months",
     ...
     //tab-two-data
    {
      ...
      description: "Designed an impactful website for a non-profit, focusing on storytelling and donation integrations.",
    ...
    },
    {
      ...
      description: "Developed a React-based admin panel template with dynamic widgets and charting capabilities.",
    ...
    //tab-three-data
    {
      ...
      description: "Created an advanced inventory management system, automating supply chain processes and reducing manual effort.",
    ...
    },
    {
      ...
      description: "Designed an elegant and user-centric interface for a mobile e-commerce app, enhancing the shopping experience.",
    ...
    },
    {
      ...
      description: "Built an app for managing events with features like RSVP tracking and push notifications.",
      technologies: ["Flutter", "Dart", "Firebase"],
      duration: "2 months",
    ...
    //tab-four-data
    {
      ...
      description: "Developed a scalable online learning platform with live classes and progress tracking features.",
      technologies: ["MongoDB", "Express", "React", "Node.js"],
      duration: "4 months",
    ...
    },
    {
      ...
      description: "Created a stunning landing page for a real estate firm, showcasing properties with interactive filters.",
      technologies: ["HTML", "CSS", "JavaScript"],
      duration: "1 month",
    ...
    //tab-four-data
    {
      ...
      description: "Created an HR management system with payroll processing and employee analytics features.",
      technologies: [".NET", "SQL Server", "C#"],
      duration: "3 months",
