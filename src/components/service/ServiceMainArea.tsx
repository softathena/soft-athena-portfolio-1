...
import breadcrumbBg from '../../../public/assets/imgs/breadcrumb/breadcrumb-bg-02.png';
...
const ServiceMainArea = () => {
    return (
        <>
            <BreadcrumbOne title="The Service We Provide is Only For Your Needs"
                subTitle='SERVICE AGENCY' breadcrumbImg={breadcrumbBg}
