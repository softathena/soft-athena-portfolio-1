    ...
    <>
      <section className="banner__area banner-height style-seven p-relative fix">
              ...
              <SwiperSlide key={item.id}>
                <div className="banner_more_item">
                  <div className="banner__single-slide">
                    <div
                      className="bg__thumb-position include-bg is-overlay"
                      ...
                      <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-9 ">
                          <div className="banner__content text-center">
                            <h1
                              className="banner__title xlarge"
                              data-animation="fadeInUp"
                              data-delay=".3s"
                            >
                              {item.title}{" "}
                              <span className="bd-text-primary">
                                {item.subTitle}
                              </span>
                            </h1>
                            <p
                            ...
                            <div
                              className="banner__btn-wrap justify-content-center"
                              data-animation="fadeInUp"
                              data-delay=".7s"
                            >
                              <Link
                                className="bd-btn is-btn-anim"
                                href="/portfolio"
                              >
        ...
        <div className="banner__navigation d-none d-md-block">
          <button className="slider__button-prev circle-btn slider__nav-btn is-btn-large">
            <i className="fa-regular fa-arrow-left-long"></i>
          </button>
          <button className="slider__button-next circle-btn slider__nav-btn is-btn-large">
